...
# cw_slang_compile(<OUT_LIST_VAR> SRC1.slang SRC2.slang ...)
# Compiles each .slang source to a corresponding .spv under ${CMAKE_BINARY_DIR}/shaders
# Returns the list of generated .spv files in OUT_LIST_VAR and creates a 'shaders' custom target.
function(cw_slang_compile OUT_LIST)
    ...
    add_custom_target(shaders ALL DEPENDS ${_outputs})
